...
#ifndef COUPLER_SWIFT_H
#define COUPLER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Coupler",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7Coupler11AppDelegate")
...
SWIFT_CLASS("_TtC7Coupler18DictViewController")
@interface DictViewController : UIViewController
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified titleLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified totalNumberLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified memorizedNumberLabel;
...
@interface DictViewController (SWIFT_EXTENSION(Coupler)) <UITableViewDataSource>
...
@interface DictViewController (SWIFT_EXTENSION(Coupler)) <UITableViewDelegate>
...
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified newWordTextField;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified meaningTextField;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified translationButton;
...
SWIFT_CLASS("_TtC7Coupler13SceneDelegate")
...
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified glossaryDictViewLabel;
...
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified glossaryViewButton;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified glossaryTrainButton;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified translationViewStatLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified glossaryViewStatLabel;
- (void)viewDidLoad;
- (void)viewWillAppear:(BOOL)animated;
- (IBAction)translationViewButtonPressed:(UIButton * _Nonnull)sender;
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified trainedLabel;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified checkmarkLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified difficultLabel;
- (void)awakeFromNib;
- (void)setSelected:(BOOL)selected animated:(BOOL)animated;
- (IBAction)toggleIsMemorized:(UIButton * _Nonnull)sender;
...
@property (nonatomic) int64_t trainedCount;
